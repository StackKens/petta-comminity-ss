            ...
            >
              {track.map((item, i) => (
                <div
                  ...
                  style={{ width: cardW }}
                >
                  <div className="relative flex h-full flex-col overflow-hidden rounded-[4px] border border-white/60 bg-white/70 px-7 pt-10 pb-8 shadow-[0_4px_20px_-4px_hsl(var(--primary)/.1)] backdrop-blur-xl transition-shadow duration-300 hover:shadow-[0_12px_48px_-4px_hsl(var(--primary)/.25)]">
                    {/* Decorative quote */}
